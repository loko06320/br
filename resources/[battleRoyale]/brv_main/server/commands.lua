...
addCommand('help', function(player, args)
  sendSystemMessage(player.source, "^2Bienvenue sur ^8Sunset Surviror!")
  sendSystemMessage(player.source, "^2Listes des commandes :")
  sendSystemMessage(player.source, "^4/help^2 : Montrer ce message")
  sendSystemMessage(player.source, "^4/skin^2 : Choisir skin aleatoire")
  sendSystemMessage(player.source, "^4/saveskin^2 : Sauvegarder skin actuel ")
  sendSystemMessage(player.source, "^4/name NEWNAME^2 : Changer votre nom pour NEWNAME")
  sendSystemMessage(player.source, "^4/vote^2 : Voter pour commencer immediatement")
  sendSystemMessage(player.source, "^2Listes des touches :")
  sendSystemMessage(player.source, "^4\"FLECHE HAUT (MAINTENIR)\"^2 : Liste des scores et classement")
  sendSystemMessage(player.source, "^4\"F\"^2 : Activer mode spectateur prés de la TV")
  sendSystemMessage(player.source, "^4\"Z\"^2 : Agrandir radar")
  sendSystemMessage(player.source, "^2Rester courtois et bon jeu !")
  return true
end)
